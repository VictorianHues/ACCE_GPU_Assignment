#!/bin/bash
#SBATCH --job-name=cuda_soa_batch_experiments
#SBATCH --output=_logs/cuda_soa_batch_experiments_out_%j.txt
#SBATCH --error=_logs/cuda_soa_batch_experiments_err_%j.txt
