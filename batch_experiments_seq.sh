#!/bin/bash
#SBATCH --job-name=seq_batch_experiments
#SBATCH --output=_logs/seq_batch_experiments_out_%j.txt
#SBATCH --error=_logs/seq_batch_experiments_err_%j.txt
...
OUTCSV="_logs/seq_batch_experiments_results.csv"
RUNS=2
